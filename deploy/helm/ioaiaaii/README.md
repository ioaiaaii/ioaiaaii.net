...
| web.livenessProbe.failureThreshold | string | `"bar"` |  |
| web.livenessProbe.initialDelaySeconds | string | `"foo"` |  |
| web.livenessProbe.periodSeconds | string | `"bar"` |  |
| web.livenessProbe.successThreshold | string | `"foo"` |  |
| web.livenessProbe.timeoutSeconds | string | `"foo"` |  |
...
| web.readinessProbe.failureThreshold | string | `"bar"` |  |
| web.readinessProbe.initialDelaySeconds | string | `"foo"` |  |
| web.readinessProbe.periodSeconds | string | `"bar"` |  |
| web.readinessProbe.successThreshold | string | `"foo"` |  |
| web.readinessProbe.timeoutSeconds | string | `"foo"` |  |
...
| web.startupProbe.failureThreshold | string | `"bar"` |  |
| web.startupProbe.initialDelaySeconds | string | `"foo"` |  |
| web.startupProbe.periodSeconds | string | `"bar"` |  |
| web.startupProbe.successThreshold | string | `"foo"` |  |
| web.startupProbe.timeoutSeconds | string | `"foo"` |  |
