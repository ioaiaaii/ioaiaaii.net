<template>
  ...
  <div class="base-container">
    ...
    <div class="p-4 sm:p-6 lg:p-8 mt-10 ">
      <h1 class="info-title">
        {{ resume.name }}
      </h1>
    </div>     
    ...
    <div class="base-grid p-4 sm:p-6 lg:p-8 grow gap-4 md:gap-6">
      <!-- Engineer Column -->
      <div>
        <h2 class="info-heading mt-4">
          Engineer
        </h2>
    ...
    <img
      class="h-auto max-w-full sm:max-w-md mx-auto"
